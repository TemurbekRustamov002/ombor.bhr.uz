  ...
  return (
    <html lang="uz" suppressHydrationWarning>
      ...
      >
        ...
        <main className={`flex-1 ${session && session.role !== 'BRIGADIER' ? 'ml-72' : ''} min-h-screen relative z-0 print:m-0 print:p-0 main-content flex flex-col`}>
          ...
          <div className={`${session && session.role === 'BRIGADIER' ? 'p-0 w-full max-w-none' : 'max-w-7xl mx-auto w-full p-8'} flex-1 print:p-0 print:max-w-none print:m-0`} suppressHydrationWarning>
            {children}
          </div>
        </main>
      </body>
